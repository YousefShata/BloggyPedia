<template>
  <div class="max-w-4xl mx-auto py-8 px-4">
    ...
    <div v-for="post in posts" :key="post.id" class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
      <div class="flex p-6">
        ...
        <div class="flex-1">
          ...
          <!-- <button @click="goToPost(post.id)" class="text-white bg-black px-4 py-2 rounded-md">Read More</button> -->
        </div>
      </div>
    </div>
  </div>
